...
function AppLayout() {
  ...
  return (
    <div className=" p-auto flex h-screen items-center justify-center overflow-auto bg-slate-300 p-7 sm:p-10">
      <div className="m-auto flex h-max flex-col rounded-md bg-white">
